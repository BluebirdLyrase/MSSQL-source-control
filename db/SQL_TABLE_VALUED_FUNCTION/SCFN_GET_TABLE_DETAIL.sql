-- =============================================
/*
SELECT * FROM SCFN_GET_TABLE_DETAIL('dbo.TEST_SCTB_USER_LOGIN')
*/
-- =============================================
CREATE FUNCTION SCFN_GET_TABLE_DETAIL
(	
	@table_name SYSNAME
)
RETURNS @T table(table_name VARCHAR(500),line VARCHAR(MAX)) 
AS
BEGIN
DECLARE 
      @object_name SYSNAME
...
insert into @T(table_name,line)
SELECT @table_name AS table_name,Line AS line
FROM SplitLines;
RETURN 
END
